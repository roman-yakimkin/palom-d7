<ul class="nav nav-tabs">
    ...
    <li>
        <a data-toggle="tab" href="#form-tab-3">{{ t('Cost') }}</a>
    </li>
    <li>
        <a data-toggle="tab" href="#form-tab-4">{{ t('Photogallery') }}</a>
    </li>
    <li>
        <a data-toggle="tab" href="#form-tab-5">{{ t('Files') }}</a>
    </li>
    <li>
        <a data-toggle="tab" href="#form-tab-6">{{ t('Sacred places') }}</a>
    </li>
    <li>
        <a data-toggle="tab" href="#form-tab-7">{{ t('Additional info') }}</a>
    </li>
</ul>
<div class="tab-content">
    ...
    <div id="form-tab-6" class="tab-pane">
        {!! render($form['field_places']) !!}
    </div>
    <div id="form-tab-7" class="tab-pane">
